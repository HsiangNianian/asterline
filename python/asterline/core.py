...
def merge_dicts(base: Mapping[str, Any], overlay: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return cast(dict[str, Any], json.loads(deep_merge_json(json.dumps(base), json.dumps(overlay))))
...
def normalize_onebot11_payload(
    ...
    """Normalize a raw OneBot11 event into Asterline's event dictionary shape."""
    return cast(
        dict[str, Any],
